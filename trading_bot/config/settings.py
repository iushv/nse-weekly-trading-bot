...
class Config:
    ...
    MAX_LOSS_PER_TRADE = _env_float("MAX_LOSS_PER_TRADE", 0.0)  # 0 = disabled; fraction of initial capital
    ADAPTIVE_REGIME_SIZE_SCALING_ENABLED = _env_bool("ADAPTIVE_REGIME_SIZE_SCALING_ENABLED", False)
    ADAPTIVE_REGIME_SIZE_MULT_FAVORABLE = _env_float("ADAPTIVE_REGIME_SIZE_MULT_FAVORABLE", 1.0)
    ADAPTIVE_REGIME_SIZE_MULT_CHOPPY = _env_float("ADAPTIVE_REGIME_SIZE_MULT_CHOPPY", 0.5)
    ADAPTIVE_REGIME_SIZE_MULT_BEARISH = _env_float("ADAPTIVE_REGIME_SIZE_MULT_BEARISH", 0.35)
    ADAPTIVE_REGIME_SIZE_MULT_DEFENSIVE = _env_float("ADAPTIVE_REGIME_SIZE_MULT_DEFENSIVE", 0.25)
    ...
    ADAPTIVE_DAILY_RSI_MIN = _env_float("ADAPTIVE_DAILY_RSI_MIN", 40.0)
    ADAPTIVE_DAILY_RSI_MAX = _env_float("ADAPTIVE_DAILY_RSI_MAX", 72.0)
    ADAPTIVE_MIN_VOLUME_RATIO = _env_float("ADAPTIVE_MIN_VOLUME_RATIO", 0.80)
    ...
    ADAPTIVE_TREND_TRAIL_TIER2_GAIN = _env_float("ADAPTIVE_TREND_TRAIL_TIER2_GAIN", 0.05)
    ADAPTIVE_TREND_TRAIL_TIER2_MULT = _env_float("ADAPTIVE_TREND_TRAIL_TIER2_MULT", 1.0)
    ADAPTIVE_TREND_TRAIL_TIER3_GAIN = _env_float("ADAPTIVE_TREND_TRAIL_TIER3_GAIN", 0.08)
    ADAPTIVE_TREND_TRAIL_TIER3_MULT = _env_float("ADAPTIVE_TREND_TRAIL_TIER3_MULT", 1.2)
    ...
    ADAPTIVE_TREND_MAX_WEEKLY_ATR_PCT = _env_float("ADAPTIVE_TREND_MAX_WEEKLY_ATR_PCT", 0.08)
    ADAPTIVE_TREND_DYNAMIC_STOP_ENABLED = _env_bool("ADAPTIVE_TREND_DYNAMIC_STOP_ENABLED", False)
    ADAPTIVE_TREND_DYNAMIC_STOP_HIGH_ATR_PCT = _env_float("ADAPTIVE_TREND_DYNAMIC_STOP_HIGH_ATR_PCT", 0.08)
    ADAPTIVE_TREND_DYNAMIC_STOP_LOW_ATR_PCT = _env_float("ADAPTIVE_TREND_DYNAMIC_STOP_LOW_ATR_PCT", 0.04)
    ADAPTIVE_TREND_DYNAMIC_STOP_HIGH_VOL_SCALE = _env_float("ADAPTIVE_TREND_DYNAMIC_STOP_HIGH_VOL_SCALE", 0.85)
    ADAPTIVE_TREND_DYNAMIC_STOP_LOW_VOL_SCALE = _env_float("ADAPTIVE_TREND_DYNAMIC_STOP_LOW_VOL_SCALE", 1.10)
    ADAPTIVE_TREND_DYNAMIC_STOP_MIN_MULT = _env_float("ADAPTIVE_TREND_DYNAMIC_STOP_MIN_MULT", 1.0)
    ADAPTIVE_TREND_DYNAMIC_STOP_MAX_MULT = _env_float("ADAPTIVE_TREND_DYNAMIC_STOP_MAX_MULT", 2.0)
