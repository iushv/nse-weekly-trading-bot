...
def build_adaptive_trend_strategy(*, log_signals: bool = True) -> AdaptiveTrendFollowingStrategy:
    return AdaptiveTrendFollowingStrategy(
        ...
        dynamic_stop_enabled=Config.ADAPTIVE_TREND_DYNAMIC_STOP_ENABLED,
        dynamic_stop_high_atr_pct=Config.ADAPTIVE_TREND_DYNAMIC_STOP_HIGH_ATR_PCT,
        dynamic_stop_low_atr_pct=Config.ADAPTIVE_TREND_DYNAMIC_STOP_LOW_ATR_PCT,
        dynamic_stop_high_vol_scale=Config.ADAPTIVE_TREND_DYNAMIC_STOP_HIGH_VOL_SCALE,
        dynamic_stop_low_vol_scale=Config.ADAPTIVE_TREND_DYNAMIC_STOP_LOW_VOL_SCALE,
        dynamic_stop_min_mult=Config.ADAPTIVE_TREND_DYNAMIC_STOP_MIN_MULT,
        dynamic_stop_max_mult=Config.ADAPTIVE_TREND_DYNAMIC_STOP_MAX_MULT,
